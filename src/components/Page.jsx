    ...
    <div>
      <div>
        <div className="relative">
          ...
          <div className="absolute inset-0 bottom-0 left-0 w-full h-2/2 bg-gradient-to-t from-black/80 to-transparent"></div>
          <div className="absolute inset-0 flex flex-col items-start justify-center px-10 ml-20 text-center text-white mt-72">
            <h1 className='text-2xl font-semibold text-green-600'>Know Us Better</h1>
            <h1 className='mt-2 text-6xl font-semibold'>About Us</h1>
          </div>
        </div>
      </div>
      ...
      <div className='flex px-24 py-20 '>
        <div className='px-5 mr-10'>
          <h1 className='text-3xl font-semibold whitespace-nowrap'>Kingster’s History</h1>
        ...
        <div className='flex'>
          <div className='px-[139px] mt-28'>
            <div >
              ...
              <h1 className='mt-5 text-3xl font-semibold'>Special Campus Tour</h1>
        ...
        <div className='flex'>
          ...
          <div className='px-[139px] mt-28'>
            <div>
              ...
              <h1 className='mt-5 text-3xl font-semibold'>Graduation</h1>
              <p className='mt-5 text-lg text-gray-600'>Campus on a tour designed for prospective graduate and professional students. You will see how our university like, facilities, studenst and life in this university. Meet our graduate admissions representative to learn more about our graduate programs and decide what it the best for you.</p>
            </div>
          </div>
        </div>
        ...
        <div className='flex'>
          <div className='px-[139px] mt-28'>
            <div >
              ...
              <h1 className='mt-5 text-3xl font-semibold'>Powerful Alumni</h1>
              <p className='mt-5 text-lg text-gray-600'>Campus on a tour designed for prospective graduate and professional students. You will see how our university like, facilities, studenst and life in this university. Meet our graduate admissions representative to learn more about our graduate programs and decide what it the best for you.</p>
            </div>
          </div>
          <div>
